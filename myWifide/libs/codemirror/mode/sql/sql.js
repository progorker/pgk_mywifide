...
CodeMirror.defineMode("sql", function(config, parserConfig) {
  ...
  function tokenBase(stream, state) {
    ...
    // '-- pattern' command
    } else if (ch == '-' && stream.match(/^- pattern */) ) {
      stream.eat('-');
      stream.eat(' ');
      stream.eat('p');
      stream.eat('a');
      ...
      return "keyword";
    // '-- workdir' command
    } else if (ch == '-' && stream.match(/^- workdir */) ) {
      stream.eat('-');
      stream.eat(' ');
      stream.eat('w');
      stream.eat('o');
      ...
      return "keyword";
    // '-- upload' command
    } else if (ch == '-' && stream.match(/^- upload*/) ) {
      stream.eat('-');
      stream.eat(' ');
      stream.eat('u');
      stream.eat('p');
      ...
      return "keyword";
    // '-- download' command
    } else if (ch == '-' && stream.match(/^- download */) ) {
      stream.eat('-');
      stream.eat(' ');
      stream.eat('d');
      stream.eat('o');
    ...
    // '-- list' command
      ...
      return "keyword";
    // '-- remove' command
    } else if (ch == '-' && stream.match(/^- remove */) ) {
      stream.eat('-');
      stream.eat(' ');
      stream.eat('r');
      stream.eat('e');
    ...
    // 'call' command
      ...
      return "keyword";
    // 'help' command
    } else if (ch == 'h' && stream.match(/^elp*/) ) {
      stream.eat('e');
      stream.eat('l');
      stream.eat('p');
      return "keyword";
    // 'source' command
    } else if (ch == 's' && stream.match(/^ource */) ) {
      stream.eat('o');
      stream.eat('u');
      stream.eat('r');
      stream.eat('c');
